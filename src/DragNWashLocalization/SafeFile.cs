...
namespace DragNWashLocalization
{
    ...
    internal static class SafeFile
    {
        ...
        // still holds open must not stop the translator from saving.
        ...
        public static void Write(string path, Encoding encoding, Action<StreamWriter> write)
        {
            ...
            if (writer == null)
            {
                ...
                // Writing the target in place is what this code did before, so
                // do that rather than refuse to save; the atomicity is what is
                // lost here, not the translator's work.
