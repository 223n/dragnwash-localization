...
namespace DragNWashLocalization
{
    ...
    internal static class VirtualClick
    {
        ...
        public static void Install(Harmony harmony)
        {
            ...
            if (target == null)
            {
                Plugin.Log("[click] GUI.Button(Rect,int,GUIContent,GUIStyle) not found; pad/trackpad clicks disabled.");
                return;
            }
            ...
            {
                Plugin.Log($"[click] GUIClip.visibleRect unavailable: {ex.Message}");
            }
        }
